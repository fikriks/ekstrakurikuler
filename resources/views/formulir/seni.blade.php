...
@section('title',"Ekstrakurikuler Bengkel Seni")
...
<div class="container">
        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="col-md-7 mx-auto">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Bengkel Seni</a></li>
                </ol>
            <div class="card ">
                <div class="card-body">
                    ...
                    @else
                        ...
                        <h4>Ekstrakurikuler Bengkel Seni</h4>
                        <div class="divider mx-auto"></div>
                    </div>
        <form action="{{ route('seni.store') }}" method="POST" class="mt-3">
        @csrf
        ...
        <button type="submit" class='btn btn-primary w-100 d-block'>Daftar</button>
            ...
            <div class="alert  mt-5">
                <strong class="font-weight-bold">Jika ada yang ingin ditanyakan,tentang ekskul bengkel seni</strong><br>
                <strong>Hubungi : 083823588767 (Kak Touvan)</strong>
                <hr>
            </div>
            </div>
